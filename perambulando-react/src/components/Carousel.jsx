  ...
  return (
    ...
    >
      <div className="carousel-container">
        ...
        <button className="carousel-control prev" onClick={(e) => { e.stopPropagation(); prevSlide(); }}>
          <i className="fas fa-chevron-left"></i>
        </button>
        <button className="carousel-control next" onClick={(e) => { e.stopPropagation(); nextSlide(); }}>
